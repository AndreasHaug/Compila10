...
public class Interpreter {
	...
	private Object exp(Object pop0, Object pop1) {
		if(pop1 instanceof Integer && pop0 instanceof Integer){
		  return Float.valueOf(Double.valueOf(Math.pow(((Integer)pop1), ((Integer)pop0))).floatValue());
		} else if(pop1 instanceof Float && pop0 instanceof Integer){
		  return Float.valueOf(Double.valueOf(Math.pow(((Float)pop1), ((Integer)pop0))).floatValue());
		} else {
